...
public interface CTGroup extends org.apache.xmlbeans.XmlObject
{
    public static final org.apache.xmlbeans.SchemaType type = (org.apache.xmlbeans.SchemaType)
        org.apache.xmlbeans.XmlBeans.typeSystemForClassLoader(CTGroup.class.getClassLoader(), "schemaorg_apache_xmlbeans.system.sE130CAA0A01A7CDE5A2B4FEB8B311707").resolveHandle("ctgroup2b13type");
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTGroup> getGroupList();
    
    /**
     * Gets array of all "group" elements
     * @deprecated
     */
    schemasMicrosoftComVml.CTGroup[] getGroupArray();
    
    /**
     * Gets ith "group" element
     */
    schemasMicrosoftComVml.CTGroup getGroupArray(int i);
     ...
     */
    void setGroupArray(schemasMicrosoftComVml.CTGroup[] groupArray);
    
    /**
     * Sets ith "group" element
     */
    void setGroupArray(int i, schemasMicrosoftComVml.CTGroup group);
    
    /**
     * Inserts and returns a new empty value (as xml) as the ith "group" element
     */
    schemasMicrosoftComVml.CTGroup insertNewGroup(int i);
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTShape> getShapeList();
    
    /**
     * Gets array of all "shape" elements
     * @deprecated
     */
    schemasMicrosoftComVml.CTShape[] getShapeArray();
    
    /**
     * Gets ith "shape" element
     */
    schemasMicrosoftComVml.CTShape getShapeArray(int i);
     ...
     */
    void setShapeArray(schemasMicrosoftComVml.CTShape[] shapeArray);
    
    /**
     * Sets ith "shape" element
     */
    void setShapeArray(int i, schemasMicrosoftComVml.CTShape shape);
    
    /**
     * Inserts and returns a new empty value (as xml) as the ith "shape" element
     */
    schemasMicrosoftComVml.CTShape insertNewShape(int i);
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTShapetype> getShapetypeList();
    
    /**
     * Gets array of all "shapetype" elements
     * @deprecated
     */
    schemasMicrosoftComVml.CTShapetype[] getShapetypeArray();
    
    /**
     * Gets ith "shapetype" element
     */
    schemasMicrosoftComVml.CTShapetype getShapetypeArray(int i);
     ...
     */
    void setShapetypeArray(schemasMicrosoftComVml.CTShapetype[] shapetypeArray);
    
    /**
     * Sets ith "shapetype" element
     */
    void setShapetypeArray(int i, schemasMicrosoftComVml.CTShapetype shapetype);
    
    /**
     * Inserts and returns a new empty value (as xml) as the ith "shapetype" element
     */
    schemasMicrosoftComVml.CTShapetype insertNewShapetype(int i);
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTArc> getArcList();
    
    /**
     * Gets array of all "arc" elements
     * @deprecated
     */
    schemasMicrosoftComVml.CTArc[] getArcArray();
    
    /**
     * Gets ith "arc" element
     */
    schemasMicrosoftComVml.CTArc getArcArray(int i);
     ...
     */
    void setArcArray(schemasMicrosoftComVml.CTArc[] arcArray);
    
    /**
     * Sets ith "arc" element
     */
    void setArcArray(int i, schemasMicrosoftComVml.CTArc arc);
    
    /**
     * Inserts and returns a new empty value (as xml) as the ith "arc" element
     */
    schemasMicrosoftComVml.CTArc insertNewArc(int i);
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTCurve> getCurveList();
    
    /**
     * Gets array of all "curve" elements
     * @deprecated
     */
    schemasMicrosoftComVml.CTCurve[] getCurveArray();
    
    /**
     * Gets ith "curve" element
     */
    schemasMicrosoftComVml.CTCurve getCurveArray(int i);
     ...
     */
    void setCurveArray(schemasMicrosoftComVml.CTCurve[] curveArray);
    
    /**
     * Sets ith "curve" element
     */
    void setCurveArray(int i, schemasMicrosoftComVml.CTCurve curve);
    
    /**
     * Inserts and returns a new empty value (as xml) as the ith "curve" element
     */
    schemasMicrosoftComVml.CTCurve insertNewCurve(int i);
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTImage> getImageList();
    
    /**
     * Gets array of all "image" elements
     * @deprecated
     */
    schemasMicrosoftComVml.CTImage[] getImageArray();
    
    /**
     * Gets ith "image" element
     */
    schemasMicrosoftComVml.CTImage getImageArray(int i);
     ...
     */
    void setImageArray(schemasMicrosoftComVml.CTImage[] imageArray);
    
    /**
     * Sets ith "image" element
     */
    void setImageArray(int i, schemasMicrosoftComVml.CTImage image);
    
    /**
     * Inserts and returns a new empty value (as xml) as the ith "image" element
     */
    schemasMicrosoftComVml.CTImage insertNewImage(int i);
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTLine> getLineList();
    
    /**
     * Gets array of all "line" elements
     * @deprecated
     */
    schemasMicrosoftComVml.CTLine[] getLineArray();
    
    /**
     * Gets ith "line" element
     */
    schemasMicrosoftComVml.CTLine getLineArray(int i);
     ...
     */
    void setLineArray(schemasMicrosoftComVml.CTLine[] lineArray);
    
    /**
     * Sets ith "line" element
     */
    void setLineArray(int i, schemasMicrosoftComVml.CTLine line);
    
    /**
     * Inserts and returns a new empty value (as xml) as the ith "line" element
     */
    schemasMicrosoftComVml.CTLine insertNewLine(int i);
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTOval> getOvalList();
    
    /**
     * Gets array of all "oval" elements
     * @deprecated
     */
    schemasMicrosoftComVml.CTOval[] getOvalArray();
    
    /**
     * Gets ith "oval" element
     */
    schemasMicrosoftComVml.CTOval getOvalArray(int i);
     ...
     */
    void setOvalArray(schemasMicrosoftComVml.CTOval[] ovalArray);
    
    /**
     * Sets ith "oval" element
     */
    void setOvalArray(int i, schemasMicrosoftComVml.CTOval oval);
    
    /**
     * Inserts and returns a new empty value (as xml) as the ith "oval" element
     */
    schemasMicrosoftComVml.CTOval insertNewOval(int i);
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTPolyLine> getPolylineList();
    
    /**
     * Gets array of all "polyline" elements
     * @deprecated
     */
    schemasMicrosoftComVml.CTPolyLine[] getPolylineArray();
    
    /**
     * Gets ith "polyline" element
     */
    schemasMicrosoftComVml.CTPolyLine getPolylineArray(int i);
     ...
     */
    void setPolylineArray(schemasMicrosoftComVml.CTPolyLine[] polylineArray);
    
    /**
     * Sets ith "polyline" element
     */
    void setPolylineArray(int i, schemasMicrosoftComVml.CTPolyLine polyline);
    
    /**
     * Inserts and returns a new empty value (as xml) as the ith "polyline" element
     */
    schemasMicrosoftComVml.CTPolyLine insertNewPolyline(int i);
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTRect> getRectList();
    
    /**
     * Gets array of all "rect" elements
     * @deprecated
     */
    schemasMicrosoftComVml.CTRect[] getRectArray();
    
    /**
     * Gets ith "rect" element
     */
    schemasMicrosoftComVml.CTRect getRectArray(int i);
     ...
     */
    void setRectArray(schemasMicrosoftComVml.CTRect[] rectArray);
    
    /**
     * Sets ith "rect" element
     */
    void setRectArray(int i, schemasMicrosoftComVml.CTRect rect);
    
    /**
     * Inserts and returns a new empty value (as xml) as the ith "rect" element
     */
    schemasMicrosoftComVml.CTRect insertNewRect(int i);
     ...
     */
    java.util.List<schemasMicrosoftComVml.CTRoundRect> getRoundrectList();
    
    /**
     * Gets array of all "roundrect" elements
     * @deprecated
     */
    schemasMicrosoftComVml.CTRoundRect[] getRoundrectArray();
    
    /**
     * Gets ith "roundrect" element
     */
    schemasMicrosoftComVml.CTRoundRect getRoundrectArray(int i);
     ...
     */
    void setRoundrectArray(schemasMicrosoftComVml.CTRoundRect[] roundrectArray);
    
    /**
     * Sets ith "roundrect" element
     */
    void setRoundrectArray(int i, schemasMicrosoftComVml.CTRoundRect roundrect);
    
    /**
     * Inserts and returns a new empty value (as xml) as the ith "roundrect" element
     */
    schemasMicrosoftComVml.CTRoundRect insertNewRoundrect(int i);
     ...
     */
    java.util.List<schemasMicrosoftComOfficeOffice.CTDiagram> getDiagramList();
    
    /**
     * Gets array of all "diagram" elements
     * @deprecated
     */
    schemasMicrosoftComOfficeOffice.CTDiagram[] getDiagramArray();
    
    /**
     * Gets ith "diagram" element
     */
    schemasMicrosoftComOfficeOffice.CTDiagram getDiagramArray(int i);
     ...
     */
    void setDiagramArray(schemasMicrosoftComOfficeOffice.CTDiagram[] diagramArray);
    
    /**
     * Sets ith "diagram" element
     */
    void setDiagramArray(int i, schemasMicrosoftComOfficeOffice.CTDiagram diagram);
    
    /**
     * Inserts and returns a new empty value (as xml) as the ith "diagram" element
     */
    schemasMicrosoftComOfficeOffice.CTDiagram insertNewDiagram(int i);
     ...
     */
    schemasMicrosoftComVml.STEditAs.Enum getEditas();
    
    /**
     * Gets (as xml) the "editas" attribute
     */
    schemasMicrosoftComVml.STEditAs xgetEditas();
     ...
     */
    void setEditas(schemasMicrosoftComVml.STEditAs.Enum editas);
    
    /**
     * Sets (as xml) the "editas" attribute
     */
    void xsetEditas(schemasMicrosoftComVml.STEditAs editas);
    ...
    {
        public static schemasMicrosoftComVml.CTGroup newInstance() {
          return (schemasMicrosoftComVml.CTGroup) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().newInstance( type, null ); }
        
        public static schemasMicrosoftComVml.CTGroup newInstance(org.apache.xmlbeans.XmlOptions options) {
          return (schemasMicrosoftComVml.CTGroup) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().newInstance( type, options ); }
        
        /** @param xmlAsString the string value to parse */
        public static schemasMicrosoftComVml.CTGroup parse(java.lang.String xmlAsString) throws org.apache.xmlbeans.XmlException {
          return (schemasMicrosoftComVml.CTGroup) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().parse( xmlAsString, type, null ); }
        
        public static schemasMicrosoftComVml.CTGroup parse(java.lang.String xmlAsString, org.apache.xmlbeans.XmlOptions options) throws org.apache.xmlbeans.XmlException {
          return (schemasMicrosoftComVml.CTGroup) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().parse( xmlAsString, type, options ); }
        
        /** @param file the file from which to load an xml document */
        public static schemasMicrosoftComVml.CTGroup parse(java.io.File file) throws org.apache.xmlbeans.XmlException, java.io.IOException {
          return (schemasMicrosoftComVml.CTGroup) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().parse( file, type, null ); }
        
        public static schemasMicrosoftComVml.CTGroup parse(java.io.File file, org.apache.xmlbeans.XmlOptions options) throws org.apache.xmlbeans.XmlException, java.io.IOException {
          return (schemasMicrosoftComVml.CTGroup) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().parse( file, type, options ); }
        
        public static schemasMicrosoftComVml.CTGroup parse(java.net.URL u) throws org.apache.xmlbeans.XmlException, java.io.IOException {
          return (schemasMicrosoftComVml.CTGroup) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().parse( u, type, null ); }
        
        public static schemasMicrosoftComVml.CTGroup parse(java.net.URL u, org.apache.xmlbeans.XmlOptions options) throws org.apache.xmlbeans.XmlException, java.io.IOException {
          return (schemasMicrosoftComVml.CTGroup) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().parse( u, type, options ); }
        
        public static schemasMicrosoftComVml.CTGroup parse(java.io.InputStream is) throws org.apache.xmlbeans.XmlException, java.io.IOException {
          return (schemasMicrosoftComVml.CTGroup) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().parse( is, type, null ); }
        
        public static schemasMicrosoftComVml.CTGroup parse(java.io.InputStream is, org.apache.xmlbeans.XmlOptions options) throws org.apache.xmlbeans.XmlException, java.io.IOException {
          return (schemasMicrosoftComVml.CTGroup) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().parse( is, type, options ); }
        
        public static schemasMicrosoftComVml.CTGroup parse(java.io.Reader r) throws org.apache.xmlbeans.XmlException, java.io.IOException {
          return (schemasMicrosoftComVml.CTGroup) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().parse( r, type, null ); }
        
        public static schemasMicrosoftComVml.CTGroup parse(java.io.Reader r, org.apache.xmlbeans.XmlOptions options) throws org.apache.xmlbeans.XmlException, java.io.IOException {
          return (schemasMicrosoftComVml.CTGroup) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().parse( r, type, options ); }
        
        public static schemasMicrosoftComVml.CTGroup parse(javax.xml.stream.XMLStreamReader sr) throws org.apache.xmlbeans.XmlException {
          return (schemasMicrosoftComVml.CTGroup) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().parse( sr, type, null ); }
        
        public static schemasMicrosoftComVml.CTGroup parse(javax.xml.stream.XMLStreamReader sr, org.apache.xmlbeans.XmlOptions options) throws org.apache.xmlbeans.XmlException {
          return (schemasMicrosoftComVml.CTGroup) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().parse( sr, type, options ); }
        
        public static schemasMicrosoftComVml.CTGroup parse(org.w3c.dom.Node node) throws org.apache.xmlbeans.XmlException {
          return (schemasMicrosoftComVml.CTGroup) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().parse( node, type, null ); }
        
        public static schemasMicrosoftComVml.CTGroup parse(org.w3c.dom.Node node, org.apache.xmlbeans.XmlOptions options) throws org.apache.xmlbeans.XmlException {
          return (schemasMicrosoftComVml.CTGroup) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().parse( node, type, options ); }
        
        /** @deprecated {@link org.apache.xmlbeans.xml.stream.XMLInputStream} */
        public static schemasMicrosoftComVml.CTGroup parse(org.apache.xmlbeans.xml.stream.XMLInputStream xis) throws org.apache.xmlbeans.XmlException, org.apache.xmlbeans.xml.stream.XMLStreamException {
          return (schemasMicrosoftComVml.CTGroup) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().parse( xis, type, null ); }
        
        /** @deprecated {@link org.apache.xmlbeans.xml.stream.XMLInputStream} */
        public static schemasMicrosoftComVml.CTGroup parse(org.apache.xmlbeans.xml.stream.XMLInputStream xis, org.apache.xmlbeans.XmlOptions options) throws org.apache.xmlbeans.XmlException, org.apache.xmlbeans.xml.stream.XMLStreamException {
          return (schemasMicrosoftComVml.CTGroup) org.apache.xmlbeans.XmlBeans.getContextTypeLoader().parse( xis, type, options ); }

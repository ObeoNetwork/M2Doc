...
layout: article
title: Reference
subtitle: Learn more about M2Doc
relativePath: ..
---

# Overview

The M2Doc project provides Word document (.docx files) generation. It is based on a document template and [Ecore](https://www.eclipse.org/modeling/emf/) models. The M2Doc template is applied on one or mode variables to produce the generated document.
...
You probably want to start with the [Download]({{page.relativePath}}/download) section. Then you might have one of the following roles:

 ...
 * </p>
 * <ul>
 *   <li>{@link org.obeonetwork.m2doc.template.impl.TableMergeImpl#getStyleRun <em>Style Run</em>}</li>
 *   <li>{@link org.obeonetwork.m2doc.template.impl.TableMergeImpl#getRuns <em>Runs</em>}</li>
 *   <li>{@link org.obeonetwork.m2doc.template.impl.TableMergeImpl#getClosingRuns <em>Closing Runs</em>}</li>
 *   <li>{@link org.obeonetwork.m2doc.template.impl.TableMergeImpl#getValidationMessages <em>Validation Messages</em>}</li>
 *   <li>{@link org.obeonetwork.m2doc.template.impl.TableMergeImpl#getLegend <em>Legend</em>}</li>
 *   <li>{@link org.obeonetwork.m2doc.template.impl.TableMergeImpl#getBody <em>Body</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableMergeImpl extends MinimalEObjectImpl.Container implements TableMerge {
    /**
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
    ...
    public void setStyleRun(XWPFRun newStyleRun) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TemplatePackage.TABLE_MERGE__STYLE_RUN, oldStyleRun, styleRun));
    }
    ...
    public EList<XWPFRun> getRuns() {
        if (runs == null) {
            runs = new EDataTypeUniqueEList<XWPFRun>(XWPFRun.class, this, TemplatePackage.TABLE_MERGE__RUNS);
        }
        return runs;
    }
    ...
    public EList<XWPFRun> getClosingRuns() {
        if (closingRuns == null) {
            closingRuns = new EDataTypeUniqueEList<XWPFRun>(XWPFRun.class, this, TemplatePackage.TABLE_MERGE__CLOSING_RUNS);
        }
        return closingRuns;
    }
    ...
    public EList<TemplateValidationMessage> getValidationMessages() {
        if (validationMessages == null) {
            validationMessages = new EDataTypeUniqueEList<TemplateValidationMessage>(TemplateValidationMessage.class, this, TemplatePackage.TABLE_MERGE__VALIDATION_MESSAGES);
        }
    ...
    public NotificationChain basicSetBody(Block newBody, NotificationChain msgs) {
        ...
        body = newBody;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, TemplatePackage.TABLE_MERGE__BODY, oldBody, newBody);
    ...
    public void setBody(Block newBody) {
        if (newBody != body) {
            ...
            if (body != null)
                msgs = ((InternalEObject)body).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - TemplatePackage.TABLE_MERGE__BODY, null, msgs);
            if (newBody != null)
                msgs = ((InternalEObject)newBody).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - TemplatePackage.TABLE_MERGE__BODY, null, msgs);
            msgs = basicSetBody(newBody, msgs);
            if (msgs != null) msgs.dispatch();
        }
        else if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TemplatePackage.TABLE_MERGE__BODY, newBody, newBody));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case TemplatePackage.TABLE_MERGE__BODY:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case TemplatePackage.TABLE_MERGE__STYLE_RUN:
                return getStyleRun();
            case TemplatePackage.TABLE_MERGE__RUNS:
                return getRuns();
            case TemplatePackage.TABLE_MERGE__CLOSING_RUNS:
                return getClosingRuns();
            case TemplatePackage.TABLE_MERGE__VALIDATION_MESSAGES:

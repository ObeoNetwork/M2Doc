...
public class UserDocImpl extends MinimalEObjectImpl.Container implements UserDoc {
    ...
    public void setStyleRun(XWPFRun newStyleRun) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, TemplatePackage.USER_DOC__STYLE_RUN, oldStyleRun,
                    styleRun));
    }
    ...
    public EList<XWPFRun> getRuns() {
        if (runs == null) {
            runs = new EDataTypeUniqueEList<>(XWPFRun.class, this, TemplatePackage.USER_DOC__RUNS);
        }
        return runs;
    }
    ...
    public EList<TemplateValidationMessage> getValidationMessages() {
        if (validationMessages == null) {
            validationMessages = new EDataTypeUniqueEList<>(TemplateValidationMessage.class,
                    this, TemplatePackage.USER_DOC__VALIDATION_MESSAGES);
        }
    ...
    public NotificationChain basicSetBody(Block newBody, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
                    TemplatePackage.USER_DOC__BODY, oldBody, newBody);
            if (msgs == null)
                msgs = notification;
        ...
        if (newBody != body) {
            ...
            if (body != null)
                msgs = ((InternalEObject) body).eInverseRemove(this,
                        EOPPOSITE_FEATURE_BASE - TemplatePackage.USER_DOC__BODY, null, msgs);
            if (newBody != null)

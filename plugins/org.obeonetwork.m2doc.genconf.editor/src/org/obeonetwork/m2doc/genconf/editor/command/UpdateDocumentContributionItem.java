...
/**
 * Contributes update document menu.
 * 
 * @author <a href="mailto:yvan.lussaud@obeo.fr">Yvan Lussaud</a>
 */
public class UpdateDocumentContributionItem extends ContributionItem {
    ...
    public void fill(Menu menu, int index) {
        ...
        if (templateURI != null) {
            for (final URI uri : GenconfPlugin.getPlugin().getGenconfURIsFromResult(templateURI)) {

...
Currently, only the tag "diagram" can be extended. But any new tag that will be added and which will be considered as extensible could have providers attached to it.  

...
* @{m:bookmark <name query>} book marked content { m:endbookmark }@ : creates a book mark with a name (name query result result) and a content.

* @{m:link <book mark name query> <text query>}@ : creates a link to a book mark. The "book mark name query" is the same as the one defines in {m:bookmark <name query>}. The text used for the reference is the result of the "text query".

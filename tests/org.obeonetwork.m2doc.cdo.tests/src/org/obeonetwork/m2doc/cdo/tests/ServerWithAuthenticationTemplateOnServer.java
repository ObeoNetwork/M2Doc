 ...
 */
public class ServerWithAuthenticationTemplateOnServer extends AbstractTemplatesTestSuite {

    /**
     * The template {@link URI} to CDO {@link URI}.
     */
    protected static final Map<String, URI> TO_CDO_MAPPING = new HashMap<String, URI>();
    ...
    public static void startCDOServer() {
        final Collection<Object[]> testFolders = retrieveTestFolders(
                "resources/serverWithAuthenticationTemplateOnServer");
    ...
    public static Collection<Object[]> retrieveTestFolders() {
        return retrieveTestFolders("resources/serverWithAuthenticationTemplateOnServer");
    }

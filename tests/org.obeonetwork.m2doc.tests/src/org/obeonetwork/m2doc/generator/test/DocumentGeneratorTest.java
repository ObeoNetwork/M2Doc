...
public class DocumentGeneratorTest extends AbstractM2DocSiriusTest {
    @Test
    ...
    public void testDiagramGeneration()
        ...
        DocumentGenerator generator = new DocumentGenerator("templates/allDiagram.docx", "results/allDiagram.docx",
                template, definitions, queryEnvironment, getSemanticResource().getContents().get(0));
        generator.generate();
    }
     ...
     * (non-Javadoc)
     * 
     * @see org.obeonetwork.m2doc.test.AbstractM2DocSiriusTest#getSemanticModelName()
     */
    @Override

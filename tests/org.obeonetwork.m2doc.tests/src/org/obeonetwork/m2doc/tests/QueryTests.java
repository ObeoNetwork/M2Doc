 ...
 */
public class QueryTests extends AbstractTemplatesTestSuite {
     ...
     */
    public QueryTests(String testFolder) throws IOException, DocumentParserException {
        super(testFolder);
    }
    ...
    public static Collection<Object[]> retrieveTestFolders() {
        return retrieveTestFolders("resources/query");
    }

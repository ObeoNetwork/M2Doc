 ...
 */
public class RepetitionTests extends AbstractTemplatesTestSuite {
     ...
     */
    public RepetitionTests(String testFolder) throws IOException, DocumentParserException {
        super(testFolder);
    }
    ...
    public static Collection<Object[]> retrieveTestFolders() {
        return retrieveTestFolders("resources/repetition");
    }

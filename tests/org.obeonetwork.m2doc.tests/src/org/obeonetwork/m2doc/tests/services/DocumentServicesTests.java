...
/**
 * Tests {@link DocumentServices}.
 * 
 * @author <a href="mailto:yvan.lussaud@obeo.fr">Yvan Lussaud</a>
 */
public class DocumentServicesTests extends AbstractTemplatesTestSuite {
     ...
     */
    public DocumentServicesTests(String testFolder) throws IOException, DocumentParserException {
        super(testFolder);
    }
    ...
    public static Collection<Object[]> retrieveTestFolders() {
        return retrieveTestFolders("resources/documentServices");
    }

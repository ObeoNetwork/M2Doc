...
/**
 * Tests {@link GenerationResultServices}.
 * 
 * @author <a href="mailto:yvan.lussaud@obeo.fr">Yvan Lussaud</a>
 */
public class GenerationResultServicesTests extends AbstractTemplatesTestSuite {
     ...
     */
    public GenerationResultServicesTests(String testFolder) throws Exception {
        super(testFolder);
    }
    ...
    public static Collection<Object[]> retrieveTestFolders() {
        return retrieveTestFolders("resources/generationResultServices");
    }

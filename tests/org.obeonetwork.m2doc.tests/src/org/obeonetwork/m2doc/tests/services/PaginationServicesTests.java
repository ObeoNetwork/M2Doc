...
/**
 * Tests {@link PaginationServices}.
 * 
 * @author <a href="mailto:yvan.lussaud@obeo.fr">Yvan Lussaud</a>
 */
public class PaginationServicesTests extends AbstractTemplatesTestSuite {
     ...
     */
    public PaginationServicesTests(String testFolder) throws IOException, DocumentParserException {
        super(testFolder);
    }

 ...
 */
public class BooleanServicesTests extends AbstractTemplatesTestSuite {
     ...
     */
    public BooleanServicesTests(String testFolder) throws IOException, DocumentParserException {
        super(testFolder);
    }
    ...
    public static Collection<Object[]> retrieveTestFolders() {
        return retrieveTestFolders("resources/booleanServices");
    }

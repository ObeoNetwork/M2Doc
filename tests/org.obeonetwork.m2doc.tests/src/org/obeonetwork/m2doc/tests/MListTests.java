 ...
 */
public class MListTests extends AbstractTemplatesTestSuite {
     ...
     */
    public MListTests(String testFolder) throws IOException, DocumentParserException {
        super(testFolder);
    }
    ...
    public static Collection<Object[]> retrieveTestFolders() {
        return retrieveTestFolders("resources/mList");
    }

 ...
 */
public class LetTests extends AbstractTemplatesTestSuite {
     ...
     */
    public LetTests(String testFolder) throws IOException, DocumentParserException {
        super(testFolder);
    }
    ...
    public static Collection<Object[]> retrieveTestFolders() {
        return retrieveTestFolders("resources/let");
    }

...
export function openProposals() {
  ...
  ajax.open("GET", "/rest?command=proposal&genconfURI=" + encodeURI(genconfURI) + "&expression=" + encodeURI(expression) + "&offset=" + offset + "&timestamp=" + Date.now(), true);
  ajax.send();
}
...
export function applyReplacement(text) {
  ...
  ajax.open("GET", "/rest?command=apply&genconfURI=" + encodeURI(genconfURI) + "&expression=" + encodeURI(expression) + "&offset=" + offset +"&completion=" + encodeURI(text) + "&timestamp=" + Date.now(), true);
  ajax.send();
}
...
export function validate(expression) {
  ...
  ajax.open("GET", "/rest?command=validate&genconfURI=" + encodeURI(genconfURI) + "&expression=" + encodeURI(expression) + "&timestamp=" + Date.now(), true);
  ajax.send();
}
...
export function evaluate(expression) {
  ...
  ajax.open("GET", "/rest?command=evaluate&genconfURI=" + encodeURI(genconfURI) + "&expression=" + encodeURI(expression) + "&timestamp=" + Date.now(), true);
  ajax.send();
}

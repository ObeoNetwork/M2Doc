 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.gendoc2.template.impl.TableImpl#getLegend <em>Legend</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableImpl extends CompoundImpl implements Table {
	/**
	...
	public void setLegend(String newLegend) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TemplatePackage.TABLE__LEGEND, oldLegend, legend));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TemplatePackage.TABLE__LEGEND:
				return getLegend();
		}
